...
namespace com.bemaservices.Security.SSO.Authenticators
{
    ...
    public class Vision2 : AuthenticationComponent, IExternalRedirectAuthentication
    {
            ...
            try
            {
                ...
                if (restResponse.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    if (accesstokenresponse.HttpStatusCode == (int)HttpStatusCode.OK)
                    {
                        ...
                        username = GetVision2User(accesstokenresponse.Data.profile, accesstokenresponse.Data.user_id);
                    }
        ...
        public static string GetVision2User(V2Profile vision2Profile, string userId)
        {
            ...
            string email = vision2Profile?.PrimaryEmail.Address;
            ...
            using (var rockContext = new RockContext())
            {
                ...
                if (user == null)
                {
                    ...
                    string lastName = vision2Profile.PrimaryName.LastName;
                    string firstName = vision2Profile.PrimaryName.FirstName;
